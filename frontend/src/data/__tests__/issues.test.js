...
console.assert(statusOptions[0].label === 'All Status', 'First option should be "All Status"')

// Test priority options (will return default when no data)
const priorityOptions = getPriorityOptions()
console.log('Priority options:', priorityOptions)
console.assert(priorityOptions.length >= 1, 'Should have at least default option')
...
console.assert(issueTypeOptions.length >= 1, 'Should have at least default option')

// Test project options (will return default when no data)
const projectOptions = getProjectOptions()
console.log('Project options:', projectOptions)
console.assert(projectOptions.length >= 1, 'Should have at least default option')
